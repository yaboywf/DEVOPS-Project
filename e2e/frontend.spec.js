...
test.describe("View Rankings Page Tests", () => {
  ...
  // Additional Feature - Screenshot of page when page fail
  // To run only this test, run: npx playwright test -g "Test Screenshot on test fail"
  // test("Test Screenshot on test fail (intentional failure)", async ({ page }) => {
  //   await page.goto(BASE_URL, { waitUntil: "networkidle" });
